...
type LabelKey = "lb.pvp.arena2v2" | "lb.pvp.arena3v3" | "lb.pvp.solo3v3" | "lb.pvp.solo1v1";

const TABS: { id: Bracket; labelKey: LabelKey; iconKey: keyof typeof CURRENCY_ICONS; placeholder?: boolean }[] = [
  { id: "2v2", labelKey: "lb.pvp.arena2v2", iconKey: "arena2v2" },
  { id: "3v3", labelKey: "lb.pvp.arena3v3", iconKey: "arena3v3" },
  { id: "soloq-3v3", labelKey: "lb.pvp.solo3v3", iconKey: "arena3v3", placeholder: true },
  { id: "soloq-1v1", labelKey: "lb.pvp.solo1v1", iconKey: "arena2v2", placeholder: true },
];
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap gap-1">
        {TABS.map((tab) => (
          ...
          >
            <img
              src={CURRENCY_ICONS[tab.iconKey]}
              alt=""
              ...
              <table className="min-w-full text-sm">
                <thead className="bg-neutral-900/80">
                  <tr className="text-left text-xs uppercase tracking-widest text-neutral-500">
                    ...
                    <th className="px-4 py-2">{t("lb.col.team")}</th>
                    <th className="px-4 py-2">{t("lb.col.rating")}</th>
                    <th className="px-4 py-2">{t("lb.col.record")}</th>
                    <th className="px-4 py-2">{t("lb.col.winrate")}</th>
                    <th className="px-4 py-2">{t("lb.col.members")}</th>
                  </tr>
                </thead>
                  ...
                  {teams.map((team, i) => (
                    <tr key={team.teamId}>
                      ...
                      <td className="px-4 py-2 text-xs text-neutral-400">
                        {team.seasonWins} – {team.seasonGames - team.seasonWins}
                      </td>
                      <td className="px-4 py-2 text-xs">
                        <span
                          className={
                            team.winRate >= 50 ? "text-emerald-300" : "text-neutral-400"
                          }
                        >
                          {team.winRate}%
                        </span>
