...
export default function Home() {
  ...
  const bgClass = EXPANSION_BG[selectedExpansion] ?? "from-neutral-800/20 via-neutral-900/10 to-transparent";

  return (
    <div className="flex flex-col gap-8">
      <div
        className={`rounded-2xl bg-gradient-to-br ${bgClass} p-6 ring-1 ring-neutral-800`}
      >
        ...
        <section className="mt-5 flex flex-col gap-4 rounded-xl border border-neutral-800 bg-neutral-900/60 p-6">
